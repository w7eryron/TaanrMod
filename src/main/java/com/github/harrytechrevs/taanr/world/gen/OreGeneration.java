package com.github.harrytechrevs.taanr.world.gen;

import com.github.harrytechrevs.taanr.config.OregenConfig;
	...
	public static void setupOreGeneration()
	{
		if(OregenConfig.generate_overworld.get())
		{
			...
			{				
				...
				biome.addFeature(Decoration.UNDERGROUND_ORES, Biome.createDecoratedFeature(Feature.ORE, new OreFeatureConfig(FillerBlockType.NATURAL_STONE, TutorialBlocks.taanr_block.getDefaultState(), OregenConfig.tutorial_chance.get()), Placement.COUNT_RANGE, new CountRangeConfig(10, 20, 0, 100)));
			//	biome.addFeature(Decoration.UNDERGROUND_ORES, Biome.createDecoratedFeature(Feature.ORE, new OreFeatureConfig(FillerBlockType.NATURAL_STONE, DIAMOND_ORE .getDefaultState(), OregenConfig.tutorial_chance.get()), Placement.COUNT_RANGE, new CountRangeConfig(10, 20, 0, 100)));
